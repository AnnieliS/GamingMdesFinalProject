...
public class DialogueVariables
{
    ...
    private static DialogueVariables instance;
    ...
    public DialogueVariables(TextAsset loadGlobalsJSON)
    {
                if (instance != null)
        {
            Debug.LogWarning("Found more than one Variable Dialogue Manager in the scene");
        }
        instance = this;
    ...
    {
        Debug.Log("Dialogue Variables instance");
        return instance;
    }
