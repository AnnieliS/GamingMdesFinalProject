...
public class RobiDialogue : MonoBehaviour
{
    [Header("Params")]
    [SerializeField] private float typingSpeed = 0.04f;
    [SerializeField] private TextAsset[] inkJSON;
    [SerializeField] private Animator robiAnim;
    [SerializeField] private GameObject robiButton;
    [SerializeField] private bool dialogueLooping = false;
    [SerializeField] bool pauseMusic = false;
    ...
    private static RobiDialogue instance;
    ...
    public static RobiDialogue GetInstance()
    {
        return instance;
    }
    ...
    private void InitilizeCurrentDialogue()
    {
        ...
        {
            EnterDialogueMode(inkJSON[inkIndex], robiAnim);
            if (inkIndex < inkJSON.Length && !onlyOnce)
            {
                inkIndex++;
                GameManager.GetInstance().SetRobiParams(scene.name, inkIndex);
            }
        }
    ...
    private IEnumerator ExitDialogueMode()
    {
        ...
        if (onlyOnce)
        {
            LevelLoader.GetInstance().TurnOffGameObject();
        }
    }
