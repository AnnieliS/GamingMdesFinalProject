        ...
        private void Interactions()
        {
                ...
                ))
            {
                ...
                else if (interactionHit.collider.CompareTag(doorTag))
                {
                    ...
                    {
                        Debug.Log("pressy press to open door");
                        _lookDoor.HideUI();
